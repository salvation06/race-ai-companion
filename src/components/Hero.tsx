      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[85vh]">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-muted-foreground/80 mb-12 font-light">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="p-4 rounded-lg bg-card/50 backdrop-blur-sm border border-border">
                <div className="text-2xl font-bold text-primary mb-1">GR86</div>
                <div className="text-xs text-muted-foreground">Platform Optimized</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card/30 backdrop-blur-sm border-2 border-primary/30 rounded-2xl p-6 md:p-8 hover:border-primary/50 transition-all duration-300">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-primary/10 border border-primary/30 mb-3">
                  <div className="w-2 h-2 bg-primary rounded-full animate-pulse" />
                  <span className="text-sm font-bold tracking-wider text-primary">HARDWARE</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-black mb-2 bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent">
                  AI CHIEF RADIO™
                </h2>
                <p className="text-muted-foreground text-sm font-light">
                  Helmet-mounted AI race engineer
                </p>
              </div>
