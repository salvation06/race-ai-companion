...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    speaker: "AI Crew Chief",
    narration: "Race analysis complete. You completed 26 laps with consistent pace improvement. Your fastest lap matched the top 5 performers. Strategy recommendations have been logged for your next session.",
    imageSrc: "/src/assets/dashboard-cockpit.png"
  },
  {
    id: 17,
